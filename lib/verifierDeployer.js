...
var Verifier = /** @class */ (function (_super) {
    ...
    function Verifier() {
        ...
        _this.verifier = [];
        _this.VERIFIER_FILE = "";
        var networkName = hardhat_1.default.network.name;
        _this.VERIFIER_FILE = path_1.default.join(process.cwd(), "./.verifier.".concat(networkName, ".json"));
        try {
            _this.verifier = require(_this.VERIFIER_FILE);
        }
        catch (_a) {
            console.log("Cant find ".concat(_this.VERIFIER_FILE, ", started from scratch"));
        }
    ...
    Verifier.prototype.baseUrl = function (networkName) {
        switch (networkName) {
            case 'mainnet':
    ...
    Verifier.prototype.isVerified = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var networkName, url, isVerified;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, hardhat_1.default.network.name];
                    case 1:
                        networkName = _a.sent();
                        url = "".concat(this.baseUrl(networkName), "/api?module=contract&action=getabi&address=").concat(address, "&apikey=").concat(this.apiKey);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.isVerified(params === null || params === void 0 ? void 0 : params.address)];
                    case 2:
                        isVerified = _a.sent();
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, hardhat_1.default.run("verify:verify", params)];
                    case 4:
                        _a.sent();
                        _a.label = 5;
                    case 5:
    ...
    Verifier.prototype._saveVerifier = function () {
        fs.writeFileSync(this.VERIFIER_FILE, JSON.stringify(this.verifier));
